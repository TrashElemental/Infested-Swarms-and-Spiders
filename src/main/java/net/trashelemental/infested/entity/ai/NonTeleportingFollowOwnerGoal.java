...
public class NonTeleportingFollowOwnerGoal extends Goal {
    ...
    public NonTeleportingFollowOwnerGoal(TamableAnimal pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
