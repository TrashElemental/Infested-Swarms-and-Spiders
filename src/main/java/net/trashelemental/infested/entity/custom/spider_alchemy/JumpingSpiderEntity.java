...
public class JumpingSpiderEntity extends AlchemySpiderEntity {
    public JumpingSpiderEntity(EntityType<? extends TamableAnimal> entityType, Level level) {
    ...
    /**
     * The Jumping Spider will follow its owner like a normal minion, and trigger its blast the
     * first time it attacks.
     */
    @Override
