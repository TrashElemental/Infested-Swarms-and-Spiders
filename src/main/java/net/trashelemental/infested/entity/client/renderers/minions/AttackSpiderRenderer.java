...
public class AttackSpiderRenderer extends MobRenderer<AttackSpiderEntity, ModSpiderModel<AttackSpiderEntity>> {
    ...
    public AttackSpiderRenderer(EntityRendererProvider.Context context) {
        super(context, new ModSpiderModel<>(context.bakeLayer(ModelLayers.SPIDER)), 0.3f);
